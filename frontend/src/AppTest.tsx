...
function App() {
  ...
  const getLlamaMessage = () => {
    if (klDivergence === null) return "SYSTEM ONLINE. AWAITING INPUT STREAM...";
    if (klDivergence < 0.1) return "MATCH CONFIRMED. HIGH FIDELITY TRANSLATION.";
    if (klDivergence < 0.5) return "VARIANCE DETECTED. WITHIN ACCEPTABLE PARAMETERS.";
    return "CRITICAL DIVERGENCE. HALLUCINATION PROBABILITY: HIGH.";
  };
